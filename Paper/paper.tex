...
\begin{itemize}
\item The post--Born corrections to the convergence power spectrum, skewness and kurtosis are well explained by the next--to--leading orders in the $\Phi$ expansion of each statistic. 
...
\item Fitting an observation with Born--approximated higher $\kappa$ moments leads to significant bias in the $(\Omega_m,w_0,\sigma_8)$ triplet, even in the presence of galaxy shape noise.    
\end{itemize}
%
