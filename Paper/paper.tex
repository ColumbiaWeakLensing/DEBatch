...
\end{equation}
%
Where $\kappa,\pmb{\gamma}$, and $\omega$ refer respectively to the WL cosmic convergence, shear and rotation.
%rotation angle. 
%ZH: not sure what you mean by rotation angle.  I replaced it by sky position
%AP: I meant rotation angle, see email attached figure for reference
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.4]{Figures/bias_ngal_convergence_momentsSN_s50_nb9.eps}
\end{center}
